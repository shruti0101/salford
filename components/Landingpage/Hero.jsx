...
const Hero = () => {
  return (
    <section className="relative h-screen w-full overflow-hidden">
      {/* Background Image */}
      <div
        className="absolute inset-0 bg-center bg-cover mt-10"
      ...
      <style jsx>{`
        ...
        .animate-diagonal-medium {
          animation: diagonal-medium 18s linear infinite;
        }

        .animate-diagonal-fast {
          animation: diagonal-fast 12s linear infinite;
        }
      `}</style>
    </section>
  );
